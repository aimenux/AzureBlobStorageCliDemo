...
namespace App
{
    public static class Program
    {
        ...
        {
            return CreateHostBuilder(args).RunCommandLineApplicationAsync<AzureBlobCommand>(args);
        }
        ...
        public static IHostBuilder CreateHostBuilder(string[] args) =>
            Host.CreateDefaultBuilder(args)
                ...
                {
                    services.AddSingleton<AzureBlobCommand>();
                    services.AddSingleton<UploadFileCommand>();
        ...
        private static void AddNonGenericLogger(this ILoggingBuilder loggingBuilder)
        {
            ...
            services.AddSingleton(serviceProvider =>
            {
                ...
                return loggerFactory.CreateLogger("AzureBlobStorageCliDemo");
            });
        }
    }
}
